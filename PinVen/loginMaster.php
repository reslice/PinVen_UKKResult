...
<body>
    <?php require_once "partial/_header.php" ?>
        <form align="center" action="login-petugas.php" method="post">
            <input class="login-form" type="text" placeholder="Username" name="user" id=""><br>
        ...
        <p style="margin:1rem" align="center"><a href="login.php">Login Sebagai Pegawai</a></p>
</body>
</html>